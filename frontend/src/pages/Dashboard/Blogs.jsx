...
const Blogs = () => {
  ...
  const handleOpenModal = (blog = null) => {
    if (blog) {
      ...
      setEditingBlog(null);
      setFormData({ title: "", category: "", author: "", content: "", tags: "", image: "", imageFile: null });
    }
    setOpenModal(true);
  };
  ...
  const handleSave = async () => {
    try {
      ...
      if (editingBlog) {
        const res = await axios.put(`${API_URL}/api/blogs/${editingBlog._id}`, data, {
  ...
  return (
    <div className="md:p-6">
      ...
      <BlogTable blogs={blogs} onEdit={handleOpenModal} onDelete={handleDelete} />
      ...
      {openModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 p-4 overflow-y-auto">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 w-full max-w-130">
            ...
            />
            {formData.image && <img src={formData.image} alt="Preview" className="w-32 h-32 object-cover rounded mb-3" />}
